...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/valhallacoin/vhcd/peer)
...
```bash
$ go get -u github.com/valhallacoin/vhcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/valhallacoin/vhcd/peer#example-package--NewOutboundPeer)  
